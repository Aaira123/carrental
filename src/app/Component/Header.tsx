...
import logoimg from '@/app/assets/header/Profil.png';
import searchlogo from '@/app/assets/header/search-normal.png';
import filter from '@/app/assets/header/filter.png';
import Notification from '@/app/assets/header/Notification.png';
      ...
      <div>
        ...
        <div className="flex justify-between items-center mx-[25px] my-[32px]">
          ...
          <div className="w-fit flex items-center gap-2">
           ...
           <div>
            <Link href={"/subscribe"}>
            <Image src={Notification} alt='bell' width={35} height={35}/>
            </Link>
           </div>
